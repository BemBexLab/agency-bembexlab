...
const ForumMap = () => {
    ...
    return (
        <>
            ...
            <div className="md:hidden w-full mt-8 px-4 sm:px-6 overflow-x-hidden">
                <div className="max-w-[1000px] mx-auto flex flex-col gap-6">
                    <div className="w-full">
                        <ContactCard />
                    </div>

                    <div className="w-full rounded-2xl p-4 sm:p-6 bg-[rgba(0,0,0,0.12)]">
                        <form className="space-y-4">
                            ...
                            <div className="pt-2">
                                <button
                                    ...
                                    className="relative w-full px-6 py-3 rounded-full text-white text-base font-light flex items-center justify-center gap-3 bg-[#1a1a1a]/60 backdrop-blur-md border border-[#ff1e00]/20 transition-all duration-300 group overflow-hidden">
            ...
            <div className="hidden md:block relative w-full mt-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 overflow-x-hidden">
                {/* Main Content: Contact Card + Form */}
                <div className="relative w-full mx-auto max-w-[1500px]">
                    {/* Desktop: side-by-side */}
                    <div className="hidden md:flex flex-row gap-6 lg:gap-12 items-stretch">
                        ...
                        <div
                            className="relative flex-1 rounded-2xl p-6 lg:p-8 bg-cover bg-center flex flex-col justify-center"
                            style={{}}
                        >
